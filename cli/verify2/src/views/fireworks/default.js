...
guiFireworks
  .add(fworks, 'fworkSpeed')
  .min(1)
  .max(10)
  .step(1)
guiFireworks
  .add(fworks, 'fworkAccel')
  .min(0)
  .max(50)
  .step(1)
...
guiParticles
  .add(fworks, 'partCount')
  .min(0)
  .max(500)
  .step(1)
guiParticles
  .add(fworks, 'partSpeed')
  .min(1)
  .max(100)
  .step(1)
guiParticles
  .add(fworks, 'partSpeedVariance')
  .min(0)
  .max(50)
  .step(1)
guiParticles
  ...
  .step(1)
guiParticles
  .add(fworks, 'partFriction')
  .min(0)
  .max(50)
  .step(1)
guiParticles
  .add(fworks, 'partGravity')
  .min(-20)
  .max(20)
  .step(1)
guiParticles
  .add(fworks, 'flickerDensity')
  .min(0)
  .max(50)
  .step(1)
...
guiOther
  .add(fworks, 'lineWidth')
  .min(1)
  .max(20)
  .step(1)
guiOther
  .add(fworks, 'clearAlpha')
  .min(0)
  .max(100)
  .step(1)
